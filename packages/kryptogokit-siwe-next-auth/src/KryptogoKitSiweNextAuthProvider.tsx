import {
  ...
  KryptogoKitAuthenticationProvider,
...
interface KryptogoKitSiweNextAuthProviderProps {
  enabled?: boolean;
  getSiweMessageOptions?: GetSiweMessageOptions;
  children: ReactNode;
}

export function KryptogoKitSiweNextAuthProvider({
  children,
  enabled,
  getSiweMessageOptions,
}: KryptogoKitSiweNextAuthProviderProps) {
